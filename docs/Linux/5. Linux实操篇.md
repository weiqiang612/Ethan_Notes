   ...
   * 如何增加一块硬盘
     ...
     * 设置可以自动挂载
       ...
       1. `vim /etc/fstab`
          ...
          ![image-20260209173137180](https://gcore.jsdelivr.net/gh/weiqiang612/My-TuChuang@main/img/Linux/image-20260209173137180.png)
...
![image-20260209174018232](https://gcore.jsdelivr.net/gh/weiqiang612/My-TuChuang@main/img/Linux/image-20260209174018232.png)
...
2. 查询指定目录的磁盘占用情况
   ...
   * 选项：
   ...
   ![image-20260209181245866](https://gcore.jsdelivr.net/gh/weiqiang612/My-TuChuang@main/img/Linux/image-20260209181245866.png)
...
![image-20260211200929048](https://gcore.jsdelivr.net/gh/weiqiang612/My-TuChuang@main/img/Linux/image-20260211200929048.png)
...
4. 设置主机名和hosts映射
   ...
   * 设置hosts映射，使得主机可以通过主机名与其他主机通信
     ...
     * windows系统设置hosts映射关系：修改 `C:\Windows\System32\drivers\etc\hosts` 文件即可，加上ip及对应的主机名
       ...
       ![image-20260219180123150](https://gcore.jsdelivr.net/gh/weiqiang612/My-TuChuang@main/img/Linux/image-20260219180123150.png)
...
4. ps命令显示的信息选项
   ...
   ![image-20260219185506846](https://gcore.jsdelivr.net/gh/weiqiang612/My-TuChuang@main/img/Linux/image-20260219185506846.png)
...
4. 案例
   ...
   * 踢掉某个非法登录用户
     ...
     ![image-20260219195930527](https://gcore.jsdelivr.net/gh/weiqiang612/My-TuChuang@main/img/Linux/image-20260219195930527.png)
   ...
   * 强制杀掉一个终端
     ...
     ![image-20260219201242816](https://gcore.jsdelivr.net/gh/weiqiang612/My-TuChuang@main/img/Linux/image-20260219201242816.png)
...
2. 常用选项
   * `-p` : 显示进程PID
   ...
   ![image-20260228151104902](https://gcore.jsdelivr.net/gh/weiqiang612/My-TuChuang@main/img/Linux/image-20260228151104902.png)
   
   * `-u` : 显示进程所属用户
   
   ![image-20260228151138687](https://gcore.jsdelivr.net/gh/weiqiang612/My-TuChuang@main/img/Linux/image-20260228151138687.png)
...
![image-20260301092728965](https://gcore.jsdelivr.net/gh/weiqiang612/My-TuChuang@main/img/Linux/image-20260301092728965.png)
...
![image-20260301093114876](https://gcore.jsdelivr.net/gh/weiqiang612/My-TuChuang@main/img/Linux/image-20260301093114876.png)
...
1. 基本介绍
   ...
   ![image-20260302190850415](https://gcore.jsdelivr.net/gh/weiqiang612/My-TuChuang@main/img/Linux/image-20260302190850415.png)

2. 系统日志文件的保存位置在 `/var/log/`

   ![image-20260302191048324](https://gcore.jsdelivr.net/gh/weiqiang612/My-TuChuang@main/img/Linux/image-20260302191048324.png)
...
2. 日志类型分为：
   ...
   ![image-20260302192638786](https://gcore.jsdelivr.net/gh/weiqiang612/My-TuChuang@main/img/Linux/image-20260302192638786.png)

3. 日志级别分为：

   ![image-20260302192550251](https://gcore.jsdelivr.net/gh/weiqiang612/My-TuChuang@main/img/Linux/image-20260302192550251.png)
...
4. 由日志服务 rsyslogd 记录的日志文件，格式包含以下4列：
   ...
   * 事件的具体信息
   ...
   ![image-20260302193109481](https://gcore.jsdelivr.net/gh/weiqiang612/My-TuChuang@main/img/Linux/image-20260302193109481.png)
...
2. 日志轮替全局配置文件：`/etc/logrotate.conf`，也可以把某个日志文件的轮替规则，写到 `/etc/logrotate.d` 目录，单独配置的轮替规则优先级更高
   ...
   ![image-20260302210147587](https://gcore.jsdelivr.net/gh/weiqiang612/My-TuChuang@main/img/Linux/image-20260302210147587.png)

3. 日志轮替配置文件参数说明

   ![image-20260302210415807](https://gcore.jsdelivr.net/gh/weiqiang612/My-TuChuang@main/img/Linux/image-20260302210415807.png)
...
4. 把自己的日志加入日志轮替
   ...
   * 在 `/etc/logrotate.d` 目录中添加自己配置文件的规则【推荐】
     ...
     ![image-20260302211006712](https://gcore.jsdelivr.net/gh/weiqiang612/My-TuChuang@main/img/Linux/image-20260302211006712.png)
...
![image-20260304182248910](https://gcore.jsdelivr.net/gh/weiqiang612/My-TuChuang@main/img/Linux/image-20260304182248910.png)
...
3. 镜像结构：添加安装包、依赖、配置等，每次操作都形成新的一层
   ...
   ![image-20260306120720605](https://gcore.jsdelivr.net/gh/weiqiang612/My-TuChuang@main/img/Linux/image-20260306120720605.png)
...
4. Dockerfile
   ...
   * 常见指令：
     ...
     ![image-20260306121853006](https://gcore.jsdelivr.net/gh/weiqiang612/My-TuChuang@main/img/Linux/image-20260306121853006.png)

   * 案例：写Dockerfile文件，构建Java应用镜像

     ![image-20260306122010000](https://gcore.jsdelivr.net/gh/weiqiang612/My-TuChuang@main/img/Linux/image-20260306122010000.png)

     ![image-20260306122125633](https://gcore.jsdelivr.net/gh/weiqiang612/My-TuChuang@main/img/Linux/image-20260306122125633.png)
...
2. docker网络常用命令
   ...
   ![image-20260306142750529](https://gcore.jsdelivr.net/gh/weiqiang612/My-TuChuang@main/img/Linux/image-20260306142750529.png)
...
- **缩进**：必须使用**空格**，不能用 Tab。通常缩进 2 个空格。
- **冒号**：所有键值对的冒号后必须加一个**空格**（如 `image: mysql`）。
- **列表**：使用短横线 `-` 开头，横线后也要加空格。
- **大小写**：YAML 对大小写敏感。

------

3. Docker Compose 核心配置指令
...
- **停止并删除容器**：`docker compose down`（这会清理掉网络，但挂载的数据卷不会掉）。
- **查看运行状态**：`docker compose ps`。
- **查看某个服务的日志**：`docker compose logs -f myapp`。
