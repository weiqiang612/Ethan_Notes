...
![image-20260315101030872|230](https://gcore.jsdelivr.net/gh/weiqiang612/My-TuChuang@main/img/CangQiong/image-20260315101030872.png)
...
1. 启动： `redis-server.exe redis.windows.conf`
   ...
   ![image-20260315104633585](https://gcore.jsdelivr.net/gh/weiqiang612/My-TuChuang@main/img/CangQiong/image-20260315104633585.png)

2. 停止：`Ctrl + C`

3. 连接服务：`redis-cli.exe -h [主机] -p [端口号] -a [密码]` （Redis默认端口号是6379）

   ![image-20260315104622325](https://gcore.jsdelivr.net/gh/weiqiang612/My-TuChuang@main/img/CangQiong/image-20260315104622325.png)
...
1. Redis存储的是key-value结构的数据，其中key是字符串类型，value有几种常用的数据类型
   ...
   ![image-20260315113644791](https://gcore.jsdelivr.net/gh/weiqiang612/My-TuChuang@main/img/CangQiong/image-20260315113644791.png)
...
1. **进入 Redis 安装目录**：假设你的 Redis 安装在 `D:\Redis`。
